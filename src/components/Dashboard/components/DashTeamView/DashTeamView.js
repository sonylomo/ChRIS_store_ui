  ...
  <div className={styles["card-body-content-parent"]}>
    <div>
      <span
        ...
        id={styles["no-plugin-info-icon"]}
      />
    </div>
    <div className={styles["dash-text-div"]}>
      <span
        className={`${styles["github-plugin-noplugin-title"]} ${styles["github-team-noplugin-title"]}`}
      >
        Teammates Panel
      </span>
...
const DashTeamView = ({ plugins, ...props }) => {
  ...
  const customHeaderFormatters = customHeaderFormattersDefinition;
